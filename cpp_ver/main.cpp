...
{
public:
    NonsenseGenerator() = default;
    NonsenseGenerator(string json_path)
    {
...
int NonsenseGenerator::get_random_num(unsigned long total)
{
...
string NonsenseGenerator::get_title()
{
...
string NonsenseGenerator::get_noun()
{
...
string NonsenseGenerator::get_verb()
{
...
string NonsenseGenerator::get_adverb(int type)
{
    string str;
    if(type == 1)
    {
...
string NonsenseGenerator::get_phrase()
{
...
string NonsenseGenerator::get_sentence()
{
...
string NonsenseGenerator::get_parallel_sentence()
{
...
string NonsenseGenerator::get_beginning()
{
...
string NonsenseGenerator::get_body()
{
...
string NonsenseGenerator::get_ending()
{
...
bool NonsenseGenerator::replace_xx(string &str, string them)
{
...
bool NonsenseGenerator::replace_vn(string &str)
{
...
bool NonsenseGenerator::replace_v(string &str)
{
...
bool NonsenseGenerator::replace_n(string &str)
{
...
bool NonsenseGenerator::replace_ss(string &str)
{
...
bool NonsenseGenerator::replace_sp(string &str)
{
...
bool NonsenseGenerator::replace_p(string &str)
{
...
void NonsenseGenerator::replace_all(string &str, string them)
{
...
static const string usage = "usage: ./NonsenseGenerator THEME NUM";
void error() {
    cout << usage << endl;
    exit(-1);
}
